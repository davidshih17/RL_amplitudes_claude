"""
Evaluate paper's pretrained 5pt model on their 5pt test set.
Adapted from spinorhelicity/main.py with npt_list=[5] and 5pt model/data paths.
"""
...
if __name__ == '__main__':
    ...
    parameters = AttrDict({
        ...
        'reload_model': os.path.join(REPO_ROOT, 'spinorhelicity', 'n5_simplifier.pth'),

        # Trainer param
        'export_data': False,
        'reload_data': f"spin_hel,{os.path.join(REPO_ROOT, 'spinorhelicity', 'data', 'n5_i1_3', 'data.prefix.counts.train_1000')},{os.path.join(REPO_ROOT, 'spinorhelicity', 'data', 'n5_i1_3', 'data.prefix.counts.valid_1000')},{os.path.join(REPO_ROOT, 'spinorhelicity', 'data', 'n5_i1_3', 'data.prefix.counts.test_1000')}",
        'reload_size': '',
        'epoch_size': 1000,
        'max_epoch': 1,
        'amp': -1,
