"""
Worker script for parallel conversion of 5pt oracle data to multi-label transitions.
Uses TermSpecificActionSpace5pt with term_slot semantics.

Total action space: 20 brackets * 11 term_slots * 19 identities = 4180 actions
"""
...
from action_space_5pt import TermSpecificActionSpace5pt, get_unique_brackets, get_term_bracket_powers
...
def convert_chunk(
    ...
    for sample in oracle_data:
        ...
        for step in sample['trajectory']:
            ...
            # Build action mask
            action_mask = build_action_mask_5pt(state_expr, action_space)
...
def main():
    parser = argparse.ArgumentParser(description='Worker for 5pt oracle to transitions conversion')
    ...
    parser.add_argument('--max_terms_obs', type=int, default=20,
    ...
    parser.add_argument('--max_brackets', type=int, default=20,
                        help='Max brackets for action space (20 for 5-point)')
