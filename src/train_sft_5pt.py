"""
SFT training with term-specific action space for 5-point amplitudes.

Uses TermSpecificActionSpace5pt with 4180 actions:
- 20 brackets (for 5-point)
...
def train(args):
    ...
    print("=" * 70)
    print("SFT Training with 5-Point Term-Specific Action Space")
    ...
    print(f"\n5-Point Action space: {action_space.identities_per_bracket} identities/bracket, "
    ...
    # Create model with 5pt action space size
    ...
    print("\n" + "=" * 70)
    print("Starting SFT training with 5-point term-specific actions...")
    print("=" * 70)
...
def main():
    parser = argparse.ArgumentParser(description='SFT training for 5-point amplitudes')
