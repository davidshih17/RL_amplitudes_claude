"""
Evaluate paper's pretrained 4pt model on their 4pt test set.
Adapted from spinorhelicity/main.py with npt_list=[4] and 4pt model/data paths.
Re-running fresh to get consistent numbers with 5pt/6pt evals.
"""
...
if __name__ == '__main__':
    ...
    parameters = AttrDict({
        ...
        'reload_model': os.path.join(REPO_ROOT, 'spinorhelicity', 'n4_i1_3_l1000_10Mex.pth'),

        # Trainer param
        'export_data': False,
        'reload_data': f"spin_hel,{os.path.join(REPO_ROOT, 'spinorhelicity', 'data', 'n4_i1_3', 'data.prefix.counts.train_1000')},{os.path.join(REPO_ROOT, 'spinorhelicity', 'data', 'n4_i1_3', 'data.prefix.counts.valid_1000')},{os.path.join(REPO_ROOT, 'spinorhelicity', 'data', 'n4_i1_3', 'data.prefix.counts.test_1000')}",
        'reload_size': '',
        'epoch_size': 1000,
        'max_epoch': 1,
        'amp': -1,
